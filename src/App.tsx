...
function App() {
    ...
    if (savedProvider) {
      ...
      if (savedApiKey) {
        try {
          ...
          setError(
            `Failed to initialize ${savedProvider.toUpperCase()} API with saved key`
          );
        }
      }
    }
  ...
  const handleSend = messageForm.handleSubmit(async (data) => {
    ...
    try {
      const response = await aiClient.processMessage(
        data.content,
                  ...
                  >
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Select your preferred AI provider and enter your API
                          key.
                        </DialogDescription>
                      </DialogHeader>
